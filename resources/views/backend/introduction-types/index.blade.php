...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Introduction Types</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('backend.introduction-types.create') }}" class="btn btn-success">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <div class="form-inline">
                                    <div class="form-group">Introduction Types</div>
                                </div>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <form method="POST" action="{{ route('backend.introduction-types.delete') }}" id="form-delete-items">
                                @method('DELETE')
                                @csrf
                                    ...
                                    @forelse ($list as $item)
                                        <tr class="ui-state-default">
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('backend.introduction-types.show', $item->id) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('backend.introduction-types.edit', $item->id) }}" class="btn btn-sm btn-warning">
