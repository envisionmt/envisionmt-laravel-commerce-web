        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('backend.products.create') }}" class="btn btn-success">
                    ...
                    <div class="card">
                        ...
                        <form id="form-search">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        @include('backend.fields.search.name-english')
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <div class="form-inline">
                                    <div class="form-group">Products</div>
                                </div>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <form method="POST" action="{{ route('backend.products.delete') }}" id="form-delete-items">
                                @method('DELETE')
                                @csrf
                                <table class="table table-hovercode" id="table-list">
                                    ...
                                    @forelse ($list as $item)
                                        <tr class="ui-state-default">
                                            ...
                                            <td>{{ $item->name_chinese }}</td>
                                            <td>{{ $item->category->name_english }}</td>
                                            <td class="text-center">{{ date('d-m-Y H:i:s', strtotime($item->created_at)) }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('backend.products.show', $item->id) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('backend.products.edit', $item->id) }}" class="btn btn-sm btn-warning">
