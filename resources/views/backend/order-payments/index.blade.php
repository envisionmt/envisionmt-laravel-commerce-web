...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Order Payments</h1>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card">
                        ...
                        <form id="form-search">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        @include('backend.fields.search.order_no')
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <div class="form-inline">
                                    <div class="form-group">Order Payments</div>
                                </div>
                            </div>
                                ...
                                @forelse ($list as $item)
                                    <tr class="ui-state-default">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('backend.order-payments.show', $item->id) }}" class="btn btn-sm btn-info">
