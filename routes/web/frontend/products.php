...
Route::get('products/checkout', 'ProductController@checkout')->name('products.checkout')->middleware(['verified', 'auth.user']);
...
Route::post('products/checkout', 'ProductController@postCheckout')->name('products.postCheckout')->middleware(['verified', 'auth.user']);
